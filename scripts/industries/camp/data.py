...
def get_seed_data(tenant_id: str) -> dict[str, Any]:
    ...
    return {
        ...
        "workflows": [
            ...
            {
                "tenant": tenant_id,
                "workflow_id": "camp_reschedule_flow",
                "name": "Reschedule Enrollment",
                "description": "Lists existing enrollments and re-books on a new date.",
                "active": True,
                "requires_caps": ["appointments"],
                "steps": [
                    {"action_code": "RESCHEDULE_APPOINTMENT", "label": "Which enrollment would you like to reschedule?", "input_required": True, "ui_type": "list", "params": {}},
                    {"action_code": "END", "label": "✅ Your enrollment has been rescheduled! Reply *hi* for main menu. 🏕️", "input_required": False, "ui_type": "list", "params": {}},
                ],
                "created_at": NOW, "updated_at": NOW, "is_mock": True,
            },
            {
                "tenant": tenant_id,
                "workflow_id": "camp_cancel_flow",
                "name": "Cancel Enrollment",
                "description": "Lists existing enrollments and cancels the chosen one.",
                "active": True,
                "requires_caps": ["appointments"],
                "steps": [
                    {"action_code": "CANCEL_APPOINTMENT", "label": "Which enrollment would you like to cancel?", "input_required": True, "ui_type": "list", "params": {}},
                    {"action_code": "END", "label": "✅ Your enrollment has been cancelled. Reply *hi* for main menu. 🏕️", "input_required": False, "ui_type": "list", "params": {}},
                ],
                "created_at": NOW, "updated_at": NOW, "is_mock": True,
            },
        ],
                    ...
                    "nodes": [
                        {
                            ...
                            "options": [
                                ...
                                {"key": "4", "label": "Reschedule Enrollment",  "next": "workflow.camp_reschedule_flow"},
                                {"key": "5", "label": "Cancel Enrollment",      "next": "workflow.camp_cancel_flow"},
                                {"key": "6", "label": "Activities & Programs",  "next": "activities_info"},
                                {"key": "7", "label": "Fees & Packages",        "next": "fees_info"},
                                {"key": "8", "label": "Location & Timings",     "next": "location_info"},
                                {"key": "9", "label": "Contact Us",             "next": "contact_info"},
                            ],
                        },
                        {
                            "id": "activities_info",
