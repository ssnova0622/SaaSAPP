    ...
    return {
        ...
        "whatsapp_triggers": [
            ...
            {"tenant": tenant_id, "trigger_id": "trigger_book",
             ...
             "action": {"kind": "invoke_action", "action_id": "workflow.clinic_booking_flow"},
            ...
            {"tenant": tenant_id, "trigger_id": "trigger_reschedule",
             ...
             "action": {"kind": "invoke_action", "action_id": "workflow.clinic_reschedule_flow"},
             "enabled": True, "priority": 7, "is_mock": True},
            {"tenant": tenant_id, "trigger_id": "trigger_cancel",
             "match": {"type": "exact", "value": "cancel"},
             "action": {"kind": "invoke_action", "action_id": "workflow.clinic_cancel_flow"},
             "enabled": True, "priority": 4, "is_mock": True},
        ],
        # ── Workflows ─────────────────────────────────────────────────────────
        "workflows": [
            {
            ...
            {
                "tenant": tenant_id,
                "workflow_id": "clinic_doctor_flow",
                "name": "Book with Specific Doctor",
                "description": "Choose doctor → consultation type → date → time → confirm.",
                "active": True,
                "requires_caps": ["appointments"],
                "steps": [
                    {"action_code": "LIST_DOCTORS",    "label": "Select your preferred doctor:",      "input_required": True,  "ui_type": "list", "params": {}},
                    {"action_code": "SHOW_SERVICES",   "label": "Select consultation type:",          "input_required": True,  "ui_type": "list", "params": {}},
                    {"action_code": "SELECT_DATE",     "label": "Choose your preferred date:",        "input_required": True,  "ui_type": "list", "params": {}},
                    {"action_code": "SELECT_TIME",     "label": "Choose an available time slot:",     "input_required": True,  "ui_type": "list", "params": {}},
                    {"action_code": "CONFIRM_BOOKING", "label": "Confirm your appointment",           "input_required": False, "ui_type": "list", "params": {}},
                    {"action_code": "END",             "label": "✅ Confirmed with your doctor! Arrive 10 minutes early. Reply *hi* for main menu. 🏥", "input_required": False, "ui_type": "list", "params": {}},
                ],
                "created_at": NOW, "updated_at": NOW, "is_mock": True,
            },
            {
                "tenant": tenant_id,
                "workflow_id": "clinic_quick_flow",
                "name": "Quick Consultation Booking",
                "description": "Select service type — doctor and slot auto-assigned.",
                "active": True,
                "requires_caps": ["appointments"],
                "steps": [
                    {"action_code": "SHOW_SERVICES",   "label": "Select consultation type — doctor auto-assigned:", "input_required": True,  "ui_type": "list", "params": {}},
                    {"action_code": "CONFIRM_BOOKING", "label": "Confirm your booking",                              "input_required": False, "ui_type": "list", "params": {}},
                    {"action_code": "END",             "label": "✅ Booked! We'll assign the first available doctor. Arrive 10 mins early. Reply *hi* for main menu.", "input_required": False, "ui_type": "list", "params": {}},
                ],
                "created_at": NOW, "updated_at": NOW, "is_mock": True,
            },
            {
                "tenant": tenant_id,
                "workflow_id": "clinic_price_list_flow",
                "name": "Services & Consultation Fees",
                "description": "Live fee list from tenant services catalog.",
                "active": True,
                "requires_caps": ["appointments"],
                "steps": [
                    {"action_code": "SHOW_SERVICE_PRICES", "label": "🩺 *Services & Consultation Fees*", "input_required": False, "ui_type": "list", "params": {}},
            ...
            {
                "tenant": tenant_id,
                "workflow_id": "clinic_reschedule_flow",
                ...
                "steps": [
                    ...
                    {"action_code": "END", "label": "✅ Your appointment has been rescheduled! Reply *hi* for main menu. 🏥", "input_required": False, "ui_type": "list", "params": {}},
                ],
                "created_at": NOW, "updated_at": NOW, "is_mock": True,
            },
            {
                "tenant": tenant_id,
                "workflow_id": "clinic_cancel_flow",
                    ...
                    "nodes": [
                        {
                            ...
                            "options": [
                                ...
                                {"key": "2", "label": "Book with Doctor",       "next": "workflow.clinic_doctor_flow"},
                                {"key": "3", "label": "Quick Booking",          "next": "workflow.clinic_quick_flow"},
                                {"key": "4", "label": "Reschedule Appointment", "next": "workflow.clinic_reschedule_flow"},
                                {"key": "5", "label": "Cancel Appointment",     "next": "workflow.clinic_cancel_flow"},
                                {"key": "6", "label": "Our Doctors & Timings",  "next": "doctors_info"},
                                {"key": "7", "label": "Services & Fees",        "next": "workflow.clinic_price_list_flow"},
                                {"key": "8", "label": "Location & Hours",       "next": "location_info"},
                                {"key": "9", "label": "🚨 Emergency",           "next": "emergency_info"},
                            ],
                        },
                        {
                            "id": "doctors_info",
