    ...
    return {
        ...
        "workflows": [
            ...
            },
            {
                ...
                "description": "Choose doctor → consultation type → date → confirm.",
                "active": True,
                "requires_caps": ["appointments"],
                "steps": [
                    ...
                    "nodes": [
                        {
                            ...
                            "options": [
                                ...
                                {"key": "4", "label": "Our Doctors & Timings",  "next": "doctors_info"},
                                {"key": "5", "label": "Services & Fees",        "next": "workflow.clinic_price_list_flow"},
                                {"key": "6", "label": "Location & Hours",       "next": "location_info"},
                                {"key": "7", "label": "🚨 Emergency",           "next": "emergency_info"},
                            ],
                        },
                        {
                            "id": "doctors_info",
