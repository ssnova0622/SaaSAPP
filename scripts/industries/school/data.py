    ...
    return {
        ...
        "whatsapp_triggers": [
            ...
            {"tenant": tenant_id, "trigger_id": "trigger_book",
             ...
             "action": {"kind": "workflow", "workflow_id": "school_meeting_flow"},
        ...
        "workflows": [
            {
                ...
                "steps": [
                    ...
                    {"action_code": "SELECT_TIME",     "label": "Choose a time slot (1–3:30 PM):","input_required": True,  "ui_type": "list", "params": {}},
                    {"action_code": "CONFIRM_BOOKING", "label": "Confirm booking",                "input_required": False, "ui_type": "list", "params": {}},
                    ...
                    "nodes": [
                        {
                            ...
                            "options": [
                                ...
                                {"key": "2", "label": "School Timings",        "next": "timings_info"},
                                {"key": "3", "label": "Academic Calendar",     "next": "calendar_info"},
                                {"key": "4", "label": "Fee Structure",         "next": "fees_info"},
                                {"key": "5", "label": "Contact Office",        "next": "contact_info"},
                            ],
                        },
                        {
                            "id": "timings_info",
