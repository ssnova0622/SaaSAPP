    ...
    return {
        ...
        "workflows": [
            ...
            },
            {
                ...
                "description": "Choose trainer → session type → date → confirm.",
                "active": True,
                "requires_caps": ["appointments"],
                "steps": [
            ...
            },
            {
                ...
                "description": "Pick session type — date and slot auto-assigned.",
                "active": True,
                "requires_caps": ["appointments"],
                "steps": [
                    {"action_code": "SHOW_SERVICES",   "label": "Pick a session type — we'll book the next available slot:", "input_required": True,  "ui_type": "list", "params": {}},
                    {"action_code": "CONFIRM_BOOKING", "label": "Confirm your session",                                       "input_required": False, "ui_type": "list", "params": {}},
                    ...
                    "nodes": [
                        {
                            ...
                            "options": [
                                ...
                                {"key": "2", "label": "Book with Trainer",     "next": "workflow.gym_trainer_flow"},
                                {"key": "3", "label": "Quick Session Booking", "next": "workflow.gym_quick_flow"},
                                {"key": "4", "label": "Membership Plans",      "next": "membership_info"},
                                {"key": "5", "label": "Class Schedule",        "next": "schedule_info"},
