        ...
        "workflows": [
            {
                ...
                "requires_caps": ["store"],
                "steps": [
                    {"action_code": "SHOW_CATEGORIES", "label": "Browse our categories:", "input_required": True,  "ui_type": "list", "params": {}},
                    {"action_code": "SHOW_PRODUCTS",   "label": "Select a product:",      "input_required": True,  "ui_type": "list", "params": {}},
                    {"action_code": "VIEW_CART",        "label": "Review your cart:",      "input_required": False, "ui_type": "list", "params": {}},
                    {"action_code": "CHECKOUT",         "label": "Confirm your order",     "input_required": False, "ui_type": "list", "params": {}},
                    {"action_code": "END",              "label": "✅ Order placed! You'll receive a confirmation shortly. Track with your Order ID. Thank you for shopping at *QuickMart*! 🛍️", "input_required": False, "ui_type": "list", "params": {}},
                ],
                "created_at": NOW, "updated_at": NOW, "is_mock": True,
            },
            {
                ...
                "requires_caps": ["store"],
                "steps": [
                    {"action_code": "COLLECT_ORDER_ID", "label": "Please share your Order ID:", "input_required": True,  "ui_type": "list", "params": {}},
                    {"action_code": "SHOW_ORDER_DETAIL","label": "Here are your order details:", "input_required": False, "ui_type": "list", "params": {}},
                    {"action_code": "END",              "label": "Our support team will contact you within 24 hours. Thank you! 🙏", "input_required": False, "ui_type": "list", "params": {}},
                ],
                "created_at": NOW, "updated_at": NOW, "is_mock": True,
            },
        ],
