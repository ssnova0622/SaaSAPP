                    ...
                    "nodes": [
                        {
                            ...
                            "options": [
                                ...
                                {"key": "2", "label": "Browse Our Cars",        "next": "cars_info"},
                                {"key": "3", "label": "Finance & EMI Plans",    "next": "finance_info"},
                                {"key": "4", "label": "Service & Maintenance",  "next": "service_info"},
                                {"key": "5", "label": "Showroom Location",      "next": "location_info"},
                            ],
                        },
                        {
                            "id": "cars_info",
