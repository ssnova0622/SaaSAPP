    ...
    return {
        ...
        "workflows": [
            ...
            },
            {
                ...
                "description": "Choose advisor → service → date → confirm.",
                "active": True,
                "requires_caps": ["appointments"],
                "steps": [
                    ...
                    "nodes": [
                        {
                            ...
                            "options": [
                                ...
                                {"key": "4", "label": "Browse Our Cars",        "next": "cars_info"},
                                {"key": "5", "label": "Finance & EMI Plans",    "next": "finance_info"},
                                {"key": "6", "label": "Service & Maintenance",  "next": "service_info"},
                                {"key": "7", "label": "Showroom Location",      "next": "location_info"},
                            ],
                        },
                        {
                            "id": "cars_info",
